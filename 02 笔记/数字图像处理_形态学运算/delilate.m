...
img_eroded1 = imdilate(img_pn,SE1);
img_eroded2 = imdilate(img_pn,SE2);
img_eroded3 = imdilate(img_pn,SE3);
img_eroded4 = imdilate(img_pn,SE4);
img_eroded5 = imdilate(img_pn,SE5);
img_eroded6 = imdilate(img_pn,SE6);
img_eroded7 = imdilate(img_pn,SE7);
